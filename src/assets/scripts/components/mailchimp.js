				...
				<form action="https://cronofobia.us18.list-manage.com/subscribe/post?u=7f7f7bf590f89ed09718581fc&id=a751d85ac9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate>
					<div id="mc_embed_signup_scroll">
						...
						<div className="indicates-required">
							<span className="asterisk">*</span> Obrigatório
						</div>
						<div className="mc-field-group">
							<label htmlFor="mce-EMAIL">Endereço de email
								<span className="asterisk">*</span>
							</label>
							<input type="email" defaultValue="zé@email.com" name="EMAIL" className="required email" id="mce-EMAIL" />
						</div>
						<div className="mc-field-group">
						...
						<div className="mc-field-group size1of2">
							<label htmlFor="mce-BIRTHDAY-month">Aniversário
								<div className="datefield">
									<span className="subfield dayfield">
										<input className="birthday " type="text" pattern="[0-9]*" defaultValue="dia" placeholder="DD" size={2} maxLength={2} name="BIRTHDAY[day]" id="mce-BIRTHDAY-day" />
									</span> /
									<span className="subfield monthfield">
										<input className="birthday " type="text" pattern="[0-9]*" defaultValue="mês" placeholder="MM" size={2} maxLength={2} name="BIRTHDAY[month]" id="mce-BIRTHDAY-month" />
									</span>
